...
export const INITIATIVES = [
  { id: 'INI-101', name: 'Agentforce Internal Rollout',     pillar: 'dap', stage: 'G2', status: 'on_track',  budget: 2400000, spent: 1080000, fte: 9, sponsor: 'Srini K. (CIO)',   pm: 'Jordan Reilly',   okrs: ['V25-Agentforce', 'V25-Employee-AI'], lastReviewed: '2026-04-21', target: '2026-09-30', tokenUsage: { monthlyM: 38.7, trendPct: 24, status: 'high' } },
  ...
  { id: 'INI-108', name: 'Customer 360 Voice (Genie+)',     pillar: 'cxt', stage: 'G0', status: 'on_track',  budget: 1200000, spent: 80000,   fte: 3, sponsor: 'Srini K. (CIO)',   pm: 'Priya Sundaram',  okrs: ['V25-Customer-360', 'V25-Agentforce'], lastReviewed: '2026-04-23', target: '2027-02-28', tokenUsage: { monthlyM: 4.2, trendPct: 8, status: 'normal' } },
  ...
  { id: 'INI-115', name: 'AI Governance Framework (CC-18)',  pillar: 'ts',  stage: 'G1', status: 'at_risk',   budget: 850000,  spent: 165000,  fte: 4, sponsor: 'Lena Wu (CTrO)',   pm: 'Aisha Patel',     okrs: ['V25-Trust', 'V25-Agentforce'], lastReviewed: '2026-03-15', target: '2026-10-31', tokenUsage: { monthlyM: 1.8, trendPct: 12, status: 'normal' } },
